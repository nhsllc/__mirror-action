...
on: [push]
  ...
      steps:
        ...
        - uses: nhsllc/mirror-action@master
          with:
            REMOTE: 'https://gitlab.com/nhsllc/mirror-action.git'
            GIT_USERNAME: <username goes here> 
...
```yaml
      steps:
        ...
        - uses: nhsllc/mirror-action@master
          with:
            REMOTE: 'ssh://git@gitlab.com/nhsllc/mirror-action.git'
...
```yaml
      steps:
        ...
        - uses: nhsllc/mirror-action@master
          with:
            REMOTE: git@gitlab.com/nhsllc/mirror-action.git
            GIT_SSH_PRIVATE_KEY: ${{ secrets.GIT_SSH_PRIVATE_KEY }}
